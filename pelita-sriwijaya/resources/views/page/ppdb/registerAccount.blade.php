...
<div class="bg-orange-50 min-h-screen flex items-center justify-center py-10">
    <div class="bg-white p-8 rounded-xl shadow-lg w-full max-w-xl border-t-8 border-orange-500">
        ...
        <form action="{{ route('ppdb.register.submit') }}" method="POST" class="space-y-5">
            ...
            <!-- Tahun Ajaran -->
            <div>
                <label for="tahun_ajaran" class="block text-sm font-semibold text-gray-700 mb-1">Tahun Ajaran <span class="text-red-500">*</span></label>
                <select id="tahun_ajaran" name="tahun_ajaran" required class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-orange-400 focus:outline-none">
            ...
            <!-- Nama Lengkap -->
            <div>
                <label for="nama_lengkap" class="block text-sm font-semibold text-gray-700 mb-1">Nama Lengkap Calon Siswa <span class="text-red-500">*</span></label>
                <input type="text" id="nama_lengkap" name="nama_lengkap" placeholder="Sesuai akta kelahiran"
            ...
            <!-- Nomor HP -->
            <div>
                <label for="nomor_handphone" class="block text-sm font-semibold text-gray-700 mb-1">Nomor Handphone (WA) <span class="text-red-500">*</span></label>
                <input type="tel" id="nomor_handphone" name="nomor_handphone" placeholder="0812xxxxxxx"
                    required class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-orange-400 focus:outline-none" />
            </div>
