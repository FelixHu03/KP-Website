...
@section('main-content')
    ...
    @if (!$gelombangAktif)
        ...
        <div class="bg-white shadow-md rounded-lg p-10 flex flex-col items-center justify-center min-h-[50vh] text-center">
            ...
            <p class="text-gray-600 text-xl max-w-lg">
                Maaf, saat ini Pesan Pelita Sriwijaya tidak membuka pendaftaran.
            </p>
            <a href="{{ route('ppdb-online.pendaftaran') }}"
                class="mt-8 px-6 py-3 bg-orange-600 text-white font-medium rounded-lg hover:bg-orange-700 transition duration-300">
                Kembali ke Menu Utama
            </a>
        </div>
    @else
        {{-- TAMPILAN FORMULIR (JIKA GELOMBANG ADA) --}}
        <div class="bg-gray-50 shadow-md rounded-lg p-6">
            <div class="max-w-4xl mx-auto">
                ...
                <form x-data="{ jenjang: '{{ $jenjang_dipilih }}' }" x-ref="form" method="POST" action="{{ route('ppdb-online.store') }}"
                        ...
                        <select id="tahun_ajaran" name="tahun_ajaran" required
                            ...
                            @foreach ($list_tahun as $item)
                                <option value="{{ $item->tahun }}"
                                    {{ old('tahun_ajaran') == $item->tahun ? 'selected' : '' }}>
                                    {{ $item->tahun }}
                                </option>
                            @endforeach
                        </select>
                        ...
                        <div class="flex flex-col md:flex-row items-start gap-4" x-data="{ nik_anak: '{{ old('nik') }}' }">
                            ...
                            <div class="w-full relative">
                                <input type="text" id="nik" name="nik" required
                                    ...
                                    :class="nik_anak.length === 16 ? 'border-green-500 focus:ring-green-500' :
                                        'border-gray-300'">
                        ...
                        <div x-show="jenjang  !== 'TK'" x-transition class="space-y-5">
                            <div class="flex flex-col md:flex-row items-start gap-4">
                                ...
                                <input type="text" id="asalsekolah" name="asalsekolah"
                                    :required="jenjang !== 'TK'" value="{{ old('asalsekolah') }}"
                        ...
                        <div x-show="jenjang === 'SMP'" x-transition class="space-y-5">
                            ...
                            <div class="flex flex-col md:flex-row items-start gap-4">
                                ...
                                <input type="file" id="foto_raport" name="foto_raport"
                                    :required="jenjang === 'SMP'" accept=".jpg,.jpeg,.png,.pdf"
                                    class="w-full text-lg file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100">
                                <p class="text-sm text-gray-500 mt-1">
                                    Format: JPG, JPEG, PNG, atau PDF. Maksimal ukuran file 2MB.
                                </p>
                            ...
                            <div class="flex flex-col md:flex-row items-start gap-4" x-data="{ nisn: '{{ old('nisn') }}' }">
                                ...
                                <div class="w-full relative">
                                    <input type="text" id="nisn" name="nisn"
                                        :required="jenjang === 'SMP'"
                                        placeholder="NISN sesuai dokumen resmi (10 Digit)" maxlength="10"
                                        inputmode="numeric" x-model="nisn"
                                        x-on:input="nisn = nisn.replace(/[^0-9]/g, '').slice(0, 10)"
                                        class="w-full border border-gray-300 rounded px-5 py-3 text-lg focus:outline-none focus:ring-2 focus:ring-orange-500 transition"
                                        :class="nisn.length === 10 ? 'border-green-500 focus:ring-green-500' :
                                            'border-gray-300'">
                                    ...
                                    <div class="flex justify-between items-start mt-1">
                                        ...
                                        <div
                                            class="flex items-center text-sm font-medium transition-all duration-300 gap-2">
                        ...
                        <div class="flex flex-col md:flex-row items-start gap-4" x-data="{ handphone: '{{ old('handphone') }}' }">
                            ...
                            <div class="w-full relative">
                                <input type="tel" id="handphone" name="handphone" required
                                    ...
                                    class="w-full border border-gray-300 rounded px-5 py-3 text-lg focus:outline-none focus:ring-2 focus:ring-orange-500 transition"
                                    :class="handphone.length >= 10 ? 'border-green-500 focus:ring-green-500' :
                                        'border-gray-300'">
                    ...
                    <h2 class="text-3xl font-semibold text-orange-600 border-b pb-2 pt-6">II. Konfirmasi Data Orang Tua
                    </h2>
