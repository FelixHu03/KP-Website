    ...
    <div class="bg-gray-50 min-h-screen flex items-center justify-center py-10">
        <div class="bg-white p-8 rounded-xl shadow-lg w-full max-w-md border-t-8 border-orange-500">
            ...
            <form action="{{ route('ppdb.login.submit') }}" method="POST" class="space-y-5">
                ...
                <!-- Email / Nomor HP -->
                <div>
                    <label for="login" class="block text-sm font-semibold text-gray-700 mb-1">Email / Nomor Handphone <span
                            class="text-red-500">*</span></label>
                    <input type="text" id="login" name="login" placeholder="Masukkan email atau no. HP" required
                        class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-orange-400 focus:outline-none" />
                </div>

                <!-- Password -->
                <div>
                    <label for="password" class="block text-sm font-semibold text-gray-700 mb-1">Password <span
                            class="text-red-500">*</span></label>
            ...
            <div class="text-sm text-center mt-4">
                ...
                <a href=" {{ route('ppdb.password.request') }}" class="font-medium text-orange-600 hover:text-orange-500">
                    Lupa password Anda?
                </a>
            </div>
        </div>
