        ...
        <div class="max-w-5xl mx-auto">
            ...
            <div class="border-b pb-4 mb-6">
                ...
                <p class="text-gray-600 mt-1">
                    Berikut adalah daftar semua calon siswa yang telah Anda daftarkan. Klik pada salah satu nama untuk melihat detail lengkap.
                </p>
            </div>
            ...
            <div class="space-y-4">
                       ...
                       class="block p-5 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-50 hover:shadow-md transition-all">
                        ...
                        <div class="flex flex-col sm:flex-row justify-between sm:items-center">
                            ...
                            <div class="mt-3 sm:mt-0 sm:text-right">
                                ...
                                <span class="inline-block bg-blue-100 text-blue-800 text-sm font-medium px-3 py-1 rounded-full mt-2">
                ...
                @empty
                    ...
                    <div class="text-center p-10 bg-white border border-dashed rounded-lg">
                        ...
                        <a href="{{ route('ppdb-online.pendaftaran') }}" class="inline-block mt-4 px-5 py-2 bg-green-700 text-white font-semibold rounded-lg hover:bg-green-800 transition">
                            Mulai Pendaftaran
                        </a>
                    </div>
                @endforelse
            ...
            <div class="mt-8">
                <a href="{{ route('ppdb-online.index') }}"
                    ...
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24" xmlns="http://www.w3.org/2000/svg">
