...
<div class="max-w-7xl mx-auto px-4 py-12" x-data="{ submitted: false, showMap: true }">
    ...
    <div x-show="submitted" x-transition class="mb-6 bg-green-100 text-green-800 px-4 py-2 rounded">
        Pesanmu telah dikirim! Terima kasih 🙌
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div>
            ...
            <form class="space-y-4" @submit.prevent="submitted = true">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <input type="text" required placeholder="Nama Lengkap" class="w-full border rounded px-3 py-2">
                    <input type="email" required placeholder="Alamat Email" class="w-full border rounded px-3 py-2">
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <input type="text" required placeholder="Subjek" class="w-full border rounded px-3 py-2">
                    <input type="text" placeholder="No. HP" class="w-full border rounded px-3 py-2">
                </div>
                <textarea required rows="4" placeholder="Pesanmu" class="w-full border rounded px-3 py-2"></textarea>
        ...
        <div>
            ...
            <ul class="space-y-4 text-gray-700">
                <li><strong>Alamat:</strong><br>Jl. Perindustrian 2 No.1369, Kebun Bunga, Kec. Sukarami, Kota Palembang, Sumatera Selatan 30961</li>
